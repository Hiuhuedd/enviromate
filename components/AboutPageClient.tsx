      ...
      <section className="section-py bg-[#f5faf2]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: <Calendar size={24} className="text-[#5dae3e]" />, label: 'Founded', value: about.founded || '2018', desc: 'Registered under the Companies Act, Cap 486' },
              { icon: <MapPin size={24} className="text-[#5dae3e]" />, label: 'Offices', value: contact.offices.length.toString(), desc: contact.offices.map(o => o.city.replace(/\s*\(HQ\)/gi, '')).join(', ') },
